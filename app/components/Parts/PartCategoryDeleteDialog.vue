      ...
      <div v-if="hasChildren || hasParts" class="space-y-4 py-4">
        <Alert variant="warning">
          ...
          <AlertDescription>
            <span v-if="hasChildren && hasParts">
              This category contains {{ childCount }} subcategories and {{ partCount }} parts.
            </span>
        ...
        <div class="flex items-start space-x-2">
          ...
          <div class="grid gap-1.5 leading-none">
            ...
            >
              Delete all subcategories and reassign parts
            </label>
            <p class="text-sm text-muted-foreground">
              Subcategories will be deleted, and parts will be unassigned from this category.
            </p>
          </div>
        </div>
      </div>
