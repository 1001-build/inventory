  ...
  <div class="relative">
    ...
    >
      ...
      <Icon
        ...
        :class="category.structural ? 'text-muted-foreground' : 'text-primary'"
      />
      ...
      <div class="flex items-center gap-1">
        <Badge v-if="category.structural" variant="outline" class="text-xs">
          Structural
        </Badge>
        <Badge v-if="category.partCount && category.partCount > 0" variant="secondary" class="text-xs">
          {{ category.partCount }}
        </Badge>
      </div>
    </div>
