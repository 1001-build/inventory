declare global {
  const ENV: typeof import('../../server/utils/environment')['ENV']
  const PermissionChecks: typeof import('../../server/utils/rbac')['PermissionChecks']
  const PermissionMatcher: typeof import('../../server/utils/rbac')['PermissionMatcher']
  const PermissionValidator: typeof import('../../server/utils/rbac')['PermissionValidator']
  const RBACDebugger: typeof import('../../server/utils/rbac')['RBACDebugger']
  const RoleUtils: typeof import('../../server/utils/rbac')['RoleUtils']
  ...
  const assertPermissionCode: typeof import('../../server/utils/rbac')['assertPermissionCode']
  const buildPaginatedResponse: typeof import('../../server/utils/pagination')['buildPaginatedResponse']
  const cachedEventHandler: typeof import('../../node_modules/nitropack/dist/runtime/internal/cache')['cachedEventHandler']
  const cachedFunction: typeof import('../../node_modules/nitropack/dist/runtime/internal/cache')['cachedFunction']
  const calculateLimitOffset: typeof import('../../server/utils/pagination')['calculateLimitOffset']
  const calculatePagination: typeof import('../../server/utils/pagination')['calculatePagination']
  ...
  const getEnvironment: typeof import('../../server/utils/environment')['getEnvironment']
  ...
  const isDevelopment: typeof import('../../server/utils/environment')['isDevelopment']
  const isError: typeof import('../../node_modules/h3')['isError']
  const isEvent: typeof import('../../node_modules/h3')['isEvent']
  const isEventHandler: typeof import('../../node_modules/h3')['isEventHandler']
  const isMethod: typeof import('../../node_modules/h3')['isMethod']
  const isNonProduction: typeof import('../../server/utils/environment')['isNonProduction']
  const isPermissionCode: typeof import('../../server/utils/rbac')['isPermissionCode']
  const isPreflightRequest: typeof import('../../node_modules/h3')['isPreflightRequest']
  const isProduction: typeof import('../../server/utils/environment')['isProduction']
  const isStaging: typeof import('../../server/utils/environment')['isStaging']
  const isStream: typeof import('../../node_modules/h3')['isStream']
  const isWebResponse: typeof import('../../node_modules/h3')['isWebResponse']
  const lazyEventHandler: typeof import('../../node_modules/h3')['lazyEventHandler']
  const nitroPlugin: typeof import('../../node_modules/nitropack/dist/runtime/internal/plugin')['nitroPlugin']
  const parseCookies: typeof import('../../node_modules/h3')['parseCookies']
  const parseFilterParams: typeof import('../../server/utils/query-parser')['parseFilterParams']
  const parseListQuery: typeof import('../../server/utils/query-parser')['parseListQuery']
  const parsePaginationParams: typeof import('../../server/utils/query-parser')['parsePaginationParams']
  const parseSortParams: typeof import('../../server/utils/query-parser')['parseSortParams']
  ...
  const validateFilters: typeof import('../../server/utils/query-parser')['validateFilters']
  const validateSortField: typeof import('../../server/utils/query-parser')['validateSortField']
...
declare global {
  ...
  // @ts-ignore
  export type { Environment } from '../../server/utils/environment'
  import('../../server/utils/environment')
  // @ts-ignore
  export type { PermissionMatcher, PermissionValidator, RoleUtils, RBACDebugger, PermissionMatcher, PermissionValidator, RoleUtils, RBACDebugger } from '../../server/utils/rbac'
  import('../../server/utils/rbac')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt/dist/core/runtime/nitro/utils/paths';
export { defineAppConfig } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt/dist/core/runtime/nitro/utils/config';
export { defineI18nLocale, defineI18nConfig } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/@nuxtjs/i18n/dist/runtime/composables/shared';
export { defineOAuthAppleEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/apple';
export { defineOAuthAtlassianEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/atlassian';
export { defineOAuthAuth0EventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/auth0';
export { defineOAuthAuthentikEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/authentik';
export { defineOAuthAzureB2CEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/azureb2c';
export { defineOAuthBattledotnetEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/battledotnet';
export { defineOAuthCognitoEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/cognito';
export { defineOAuthDiscordEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/discord';
export { defineOAuthDropboxEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/dropbox';
export { defineOAuthFacebookEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/facebook';
export { defineOAuthGiteaEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/gitea';
export { defineOAuthGitHubEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/github';
export { defineOAuthGitLabEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/gitlab';
export { defineOAuthGoogleEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/google';
export { defineOAuthHerokuEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/heroku';
export { defineOAuthHubspotEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/hubspot';
export { defineOAuthInstagramEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/instagram';
export { defineOAuthKeycloakEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/keycloak';
export { defineOAuthKickEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/kick';
export { defineOAuthLineEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/line';
export { defineOAuthLinearEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/linear';
export { defineOAuthLinkedInEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/linkedin';
export { defineOAuthLiveChatEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/livechat';
export { defineOAuthMicrosoftEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/microsoft';
export { defineOAuthOktaEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/okta';
export { defineOAuthOryEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/ory';
export { defineOAuthPaypalEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/paypal';
export { defineOAuthPolarEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/polar';
export { defineOAuthRobloxEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/roblox';
export { defineOAuthSalesforceEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/salesforce';
export { defineOAuthSeznamEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/seznam';
export { defineOAuthSlackEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/slack';
export { defineOAuthSpotifyEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/spotify';
export { defineOAuthSteamEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/steam';
export { defineOAuthStravaEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/strava';
export { defineOAuthTikTokEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/tiktok';
export { defineOAuthTwitchEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/twitch';
export { defineOAuthVKEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/vk';
export { defineOAuthWorkOSEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/workos';
export { defineOAuthXEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/x';
export { defineOAuthXSUAAEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/xsuaa';
export { defineOAuthYandexEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/yandex';
export { defineOAuthZitadelEventHandler } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/zitadel';
export { getAtprotoClientMetadata } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/utils/atproto';
export { hashPassword, verifyPassword } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/utils/password';
export { sessionHooks, getUserSession, setUserSession, replaceUserSession, clearUserSession, requireUserSession } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/nuxt-auth-utils/dist/runtime/server/utils/session';
export { ENV, isDevelopment, isStaging, isProduction, getEnvironment, isNonProduction } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/server/utils/environment';
export { PermissionMatcher, PermissionValidator, RoleUtils, RBACDebugger, isPermissionCode, assertPermissionCode, PermissionChecks } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/server/utils/rbac';
export { calculatePagination, buildPaginatedResponse, calculateLimitOffset } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/server/utils/pagination';
export { parsePaginationParams, parseSortParams, parseFilterParams, parseListQuery, validateSortField, validateFilters } from '/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/server/utils/query-parser';