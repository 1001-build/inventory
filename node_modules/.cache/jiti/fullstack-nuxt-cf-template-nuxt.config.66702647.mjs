...
var _nodeUrl = await jitiImport("node:url");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };} // https://nuxt.com/docs/api/configuration/nuxt-config
...
defineNuxtConfig({
  ...
  alias: {
    "#server": (0, _nodeUrl.fileURLToPath)(new URL("./server", "file:///Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/nuxt.config.ts")),
    "#shared": (0, _nodeUrl.fileURLToPath)(new URL("./shared", "file:///Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/nuxt.config.ts"))
  },
  nitro: {
