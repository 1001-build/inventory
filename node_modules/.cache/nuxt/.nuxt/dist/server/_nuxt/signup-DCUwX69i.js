import { _ as _sfc_main$1, a as _sfc_main$2, b as _sfc_main$3, d as _sfc_main$4, e as _sfc_main$a } from "./CardTitle-B0sT5mvd.js";
import { _ as _sfc_main$5, a as _sfc_main$6, b as _sfc_main$7, c as _sfc_main$8 } from "./FormMessage-D4KeWMj_.js";
import { useForm, Field } from "vee-validate";
import { _ as _sfc_main$9 } from "./Input-DoaBkiNg.js";
import { _ as _sfc_main$b } from "./index-D7qPg01d.js";
import __nuxt_component_3 from "./index-CJBfPSQ0.js";
import { resolveDirective, mergeProps, withCtx, unref, createTextVNode, toDisplayString, createVNode, withDirectives, createBlock, openBlock, withModifiers, useSSRContext } from "/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/vue/index.mjs";
import { ssrRenderComponent, ssrInterpolate, ssrGetDirectiveProps } from "vue/server-renderer";
import { toTypedSchema } from "@vee-validate/zod";
import { signupSchema } from "/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/shared/validators/auth";
import "/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/hookable/dist/index.mjs";
import { a as useI18n, n as navigateTo } from "../server.mjs";
      ...
      _push(ssrRenderComponent(_component_Card, mergeProps({ class: "w-[95%] md:w-[400px] flex flex-col signup-card" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_CardTitle, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(unref(t)("auth.signup.title"))}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(unref(t)("auth.signup.title")), 1)
                        ];
                      }
                    }),
                    _: 1
                          ...
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_FormLabel, mergeProps({ class: "flex items-center justify-between text-sm md:text-base" }, ssrGetDirectiveProps(_ctx, _directive_auto_animate)), {
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span${_scopeId5}>Last Name</span>`);
                                    _push6(ssrRenderComponent(_component_FormMessage, null, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode("span", null, "Last Name"),
                                      createVNode(_component_FormMessage)
                                    ];
                                  }
                                }),
                          ...
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_FormLabel, mergeProps({ class: "flex items-center justify-between text-sm md:text-base" }, ssrGetDirectiveProps(_ctx, _directive_auto_animate)), {
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span${_scopeId5}>${ssrInterpolate(unref(t)("auth.signup.email.title"))}</span>`);
                                    _push6(ssrRenderComponent(_component_FormMessage, null, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode("span", null, toDisplayString(unref(t)("auth.signup.email.title")), 1),
                                      createVNode(_component_FormMessage)
                                    ];
                                  }
                                }),
                                ...
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_Input, mergeProps({
                                      type: "email",
                                      autocomplete: "email",
                                      placeholder: unref(t)("auth.signup.email.placeholder")
                                    }, field), null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(_component_Input, mergeProps({
                          ...
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_FormLabel, mergeProps({ class: "flex items-center justify-between text-sm md:text-base" }, ssrGetDirectiveProps(_ctx, _directive_auto_animate)), {
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span${_scopeId5}>${ssrInterpolate(unref(t)("auth.signup.password.title"))}</span>`);
                                    _push6(ssrRenderComponent(_component_FormMessage, null, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode("span", null, toDisplayString(unref(t)("auth.signup.password.title")), 1),
                                      createVNode(_component_FormMessage)
                                    ];
                                  }
                                }),
                                ...
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_Input, mergeProps({
                                      ...
                                      placeholder: unref(t)("auth.signup.password.placeholder")
                                    }, field), null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(_component_Input, mergeProps({
                          ...
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_FormLabel, mergeProps({ class: "flex items-center justify-between text-sm md:text-base" }, ssrGetDirectiveProps(_ctx, _directive_auto_animate)), {
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span${_scopeId5}>${ssrInterpolate(unref(t)("auth.signup.confirmPassword.title"))}</span>`);
                                    _push6(ssrRenderComponent(_component_FormMessage, null, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode("span", null, toDisplayString(unref(t)("auth.signup.confirmPassword.title")), 1),
                                      createVNode(_component_FormMessage)
                                    ];
                                  }
                                }),
                                ...
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_Input, mergeProps({
                                      type: "password",
                                      autocomplete: "new-password",
                                      placeholder: unref(t)("auth.signup.confirmPassword.placeholder")
                                    }, field), null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(_component_Input, mergeProps({
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (unref(isSubmitting)) {
                          ...
                          _push4(`<span class="ml-2"${_scopeId3}>${ssrInterpolate(unref(t)("auth.signup.submitting"))}</span></div>`);
                        } else {
                          _push4(`<div${_scopeId3}>${ssrInterpolate(unref(t)("auth.signup.submitButton"))}</div>`);
                        }
                      } else {
                        return [
                          unref(isSubmitting) ? (openBlock(), createBlock("div", {
                            ...
                            createVNode("span", { class: "ml-2" }, toDisplayString(unref(t)("auth.signup.submitting")), 1)
                          ])) : (openBlock(), createBlock("div", { key: 1 }, toDisplayString(unref(t)("auth.signup.submitButton")), 1))
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(_component_Button, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(unref(t)("auth.signup.haveAccountButton"))}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(unref(t)("auth.signup.haveAccountButton")), 1)
                        ];
                      }
                    }),
                    _: 1
            ...
            _push2(`</form><div class="flex items-center gap-4 px-4"${_scopeId}><div class="w-full h-0.5 bg-accent"${_scopeId}></div><span${_scopeId}>${ssrInterpolate(unref(t)("auth.signup.seperator"))}</span><div class="w-full h-0.5 bg-accent"${_scopeId}></div></div><div class="w-full flex justify-center items-center gap-8 px-4 pb-4"${_scopeId}><button class="hover:cursor-pointer"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "logos:google-icon",
              class: "w-8 h-8 md:w-16 md:h-16"
            }, null, _parent2, _scopeId));
            _push2(`</button><button class="hover:cursor-pointer"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "cib:line",
              class: "w-8 h-8 md:w-16 md:h-16 text-green-500"
            }, null, _parent2, _scopeId));
            _push2(`</button></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "flex items-center gap-4 px-4" }, [
                createVNode("div", { class: "w-full h-0.5 bg-accent" }),
                createVNode("span", null, toDisplayString(unref(t)("auth.signup.seperator")), 1),
                createVNode("div", { class: "w-full h-0.5 bg-accent" })
              ]),
              createVNode("div", { class: "w-full flex justify-center items-center gap-8 px-4 pb-4" }, [
                createVNode("button", { class: "hover:cursor-pointer" }, [
                  createVNode(_component_Icon, {
                    name: "logos:google-icon",
                    class: "w-8 h-8 md:w-16 md:h-16"
                  })
...
//# sourceMappingURL=signup-DCUwX69i.js.map
