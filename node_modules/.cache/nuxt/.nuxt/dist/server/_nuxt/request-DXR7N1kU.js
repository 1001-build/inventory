...
import { resolveDirective, mergeProps, withCtx, createTextVNode, createVNode, unref, withDirectives, createBlock, openBlock, withModifiers, useSSRContext } from "/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/node_modules/vue/index.mjs";
import { ssrRenderComponent, ssrGetDirectiveProps } from "vue/server-renderer";
import { toTypedSchema } from "@vee-validate/zod";
import { passwordResetRequestSchema } from "/Users/alsey89/Documents/code/personal/fullstack-nuxt-cf-template/shared/validators/auth";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Card, mergeProps({ class: "w-[95%] md:w-[400px] flex flex-col password-reset-card" }, _attrs), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_CardDescription, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Enter your email to receive a password reset link`);
                      } else {
                        return [
                          createTextVNode("Enter your email to receive a password reset link")
                        ];
                      }
                    }),
                    _: 1
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_FormLabel, mergeProps({ class: "flex items-center justify-between text-sm md:text-base" }, ssrGetDirectiveProps(_ctx, _directive_auto_animate)), {
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span${_scopeId5}>Email</span>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (unref(isSubmitting)) {
                          ...
                          _push4(`<span class="ml-2"${_scopeId3}>Sending...</span></div>`);
                        } else {
                          _push4(`<div${_scopeId3}> Send Reset Link </div>`);
                        }
                      } else {
                        return [
                          unref(isSubmitting) ? (openBlock(), createBlock("div", {
                            ...
                            createVNode("span", { class: "ml-2" }, "Sending...")
                          ])) : (openBlock(), createBlock("div", { key: 1 }, " Send Reset Link "))
                        ];
                      }
                    }),
                    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/auth/password/reset/request.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=request-DXR7N1kU.js.map
