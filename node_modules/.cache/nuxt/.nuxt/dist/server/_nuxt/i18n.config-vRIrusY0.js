  ...
  messages: {
    ...
    en: {
        ...
        signin: {
          ...
          toast: {
            authRequired: {
              ...
              description: "Either your session has expired or you are not logged in."
            }
          }
        },
        signup: {
      ...
      errors: {
        ...
        INVALID_TOKEN: {
          title: "Invalid Token",
          description: "The authentication token is invalid. Please sign in again."
        },
        INVALID_TOKEN_PURPOSE: {
          title: "Invalid Token",
          description: "This token cannot be used for this action. Please try again."
        },
        TOKEN_EXPIRED: {
        ...
        TENANT_ID_TAKEN: {
          ...
          description: "This tenant ID is already in use. Please choose another."
        },
...
//# sourceMappingURL=i18n.config-vRIrusY0.js.map
